...
<body>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #dfe4ea;">
    <div class="container-fluid">
      <a class="navbar-brand logo" href="index.php">Family Bank</a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item btn btn-secondary">
            <a class="nav-link link-text text-white" href="transfer_money.php">Transfer Money</a>
          </li>
		   <li class="nav-item btn btn-secondary">
            <a class="nav-link link-text text-white" href="transactionhistory.php">Transaction History</a>
          </li>
          <li class="nav-item btn btn-secondary">
